...
namespace Telephone.Presentation.WinForm
{
    public partial class TestChartForm : Form
    {
        ...
        {
            IEnumerable<IStockKLine> tickers = CurrentData.Instance.DateReader.GetKLineDay(this.txtTicker.Text.Trim(), this.dtpStart.Value, DateTime.Now);
            IEnumerable<IStockKLine> tickersEx = CurrentData.Instance.DateReader.GetKLineDay(this.txtTicker.Text.Trim(), this.dtpStart.Value.AddDays(-30), DateTime.Now);
        ...
        {
            IEnumerable<IParticipation> participations = CurrentData.Instance.DateReader.GetParticipationData(this.txtTicker.Text.Trim());
